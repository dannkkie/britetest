...
from brite.services.movie_service import add_movie, delete_movie, fetch_movie_by_id, fetch_movie_by_title, fetch_movies
...
class GetMovies(Resource):
    def get(self):
        ...
        parser.add_argument(
            'limit', type=int, help='Number of records to return', default=10, location='args')
        parser.add_argument(
...
class AddMovie(Resource):
    def post(self):
        ...
        parser.add_argument('title', type=str, required=True,
                            help='Movie title provided', location='json')
        args = parser.parse_args()
